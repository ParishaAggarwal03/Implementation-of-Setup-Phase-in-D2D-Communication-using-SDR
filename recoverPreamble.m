...
while (searchOffset+minPktLen)<=rxWaveformLen
    ...
    %wlanPacketDetect(rxSig,cbw) estimates the timing offset between the start of received signal rxSig and the start of the detected preamble for channel bandwidth cbw.
